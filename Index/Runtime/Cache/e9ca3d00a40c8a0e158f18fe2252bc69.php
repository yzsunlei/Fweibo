            ...
            <div class="weibo">
                ...
                <div class="face">
                    <a href="<?php echo U('/' . $v['uid']);?>">
                        ...
                        <?php else: ?>
                            __PUBLIC__/Images/noface.gif<?php endif; ?>" width='50' height='50'/>
                    </a>
                </div>
                <div class="wb_cons">
                    <dl>
                    ...
                    <!--发布内容-->
                        <dd class='content'>
                            <p><?php echo (replace_weibo($v["content"])); ?></p><!--###表示调用本身-->
                        </dd>
                    <!--微博图片-->
                    <?php if($v['max']): ?><dd>
                            <div class='wb_img'>
                    ...
                    <?php else: ?>
                        <dd>
                            <div class="wb_turn">
                                ...
                                <!--原作者-->
                                    <dt class='turn_name'>
                                        <a href="#">@<?php echo ($v["isturn"]["username"]); ?></a>
                                    </dt>
                                <!--原微博内容-->
                                    <dd class='turn_cons'>
                ...
                <maybe uid='$_SESSION["uid"]'>
                    <li>
                        <dl>
                            <dt>
                                <a href="<?php echo U('/' . $uid);?>">
                                    <img src="<?php if($face): ?>__ROOT__/Uploads/Face/<?php echo ($face); else: ?>__PUBLIC__/Images/noface.gif<?php endif; ?>" width='30' height='30'/>
                                </a>
                            </dt>
